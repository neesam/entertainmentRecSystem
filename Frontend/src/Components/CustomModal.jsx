                            ...
                            <Card style={{ width: '18rem' }}>
                                ...
                                <Card.Body>
                                    ...
                                    {album.artist_genres.map((genre, index) => (
                                            index == allModalAlbums.length + 1 ? (
                                                <Card.Subtitle className='mb-1' style={{fontSize: '16px'}}>Genres: {genre}</Card.Subtitle>
                                            ) :
                                            <Card.Subtitle className='mb-3' style={{fontSize: '16px'}}>Genres: {genre}</Card.Subtitle>
                                        ))}
